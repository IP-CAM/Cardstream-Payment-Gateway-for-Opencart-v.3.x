...
require_once DIR_SYSTEM . 'library/cardstream/Gateway.php';
require_once DIR_SYSTEM . 'library/cardstream/ClientInterface.php';
require_once DIR_SYSTEM . 'library/cardstream/Client.php';
require_once DIR_SYSTEM . 'library/cardstream/AmountHelper.php';
...
class ControllerExtensionPaymentCardstream extends Controller
{
	...
	private function captureOrder()
	{
		...
		if (
			...
			$table_name = DB_PREFIX . 'cardstream_wallets';
			$sql = <<<SQL
